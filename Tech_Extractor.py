...
last_hour_date_time = datetime.datetime.now() + datetime.timedelta(hours=4, minutes=30)
date = str(last_hour_date_time.strftime("%#d %B %Y"))            # return as a string format: dd-mm-yy eg:- 7 April 2021
